...
export const panelVersionNumber = '2023-04-20 - 1.0.0.04'; //Added to show in panel
...
export function aboutTable( bannerProps: IWebpartBannerProps ): { table: IHelpTable } {
    ...
    table.rows.push( createAboutRow('2023-04-20',"1.0.0.04","", bannerProps.showRepoLinks === true ? bannerProps.gitHubRepo : null ) );
